...
const JobCard=(props: any)=>{
    ...
    return <div  className="  bg-mine-shaft-900 p-4 w-72 flex flex-col gap-3 rounded-xl hover:shadow 
[0_0_5px_1px_yellow] !shadow-amber-400 sm-mx:w-full">
        <div className="flex justify-between">
            <div className="flex gap-2 items-center">
                ...
                <div>
                    ...
                    <div className="text-xs text-mine-shaft-300 "><Link className="hover:text-mine-shaft-200 "
                    to="/company">{props.company}</Link> 
            ...
            onClick={handleSaveJob} className="cursor-pointer text-amber-400 "
             stroke={1.5} />:<IconBookmark onClick={handleSaveJob}  className="cursor-pointer   hover:text-amber-400 text-mine-shaft-300 "
             stroke={1.5} />}
         </div>
        <div className="flex gap-2 [&>div]:py-1 [&>div]:px-2 [&>div]:bg-mine-shaft-800 [&>div]:text-amber-400 
